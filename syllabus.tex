...
\begin{itemize}
    ...
    \item \textbf{Product Owner} -- (Abhai Yadav (CLD-400)) prioritizes which features matter most for the capstone demo and writes acceptance criteria for each week's deliverable.
