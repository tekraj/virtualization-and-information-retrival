...
\begin{itemize}
    \item \textbf{Project Manager} -- owns the week-by-week timeline, runs stand-ups, and tracks deliverables against this syllabus.
    \item \textbf{Product Owner} -- prioritizes which features matter most for the capstone demo and writes acceptance criteria for each week's deliverable.
